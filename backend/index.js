...
                const { username, email, password, bio, profilePictureUrl } = await request.json(); // <--- ADD bio and profilePictureUrl here
...
                    email,
                    hashedPassword,
                    bio || null,             // <--- Set bio to null if not provided
                    profilePictureUrl || null  // <--- Set profilePictureUrl to null if not provided
                ).run();
